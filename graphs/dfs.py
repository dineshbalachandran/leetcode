...
class Graph:
    ...
    def create_static_graph(self):
      self.graph_list[0] = [5]
      self.graph_list[1] = [3, 7]
      self.graph_list[2] = [4, 3, 8, 9]
      self.graph_list[3] = [3]
      self.graph_list[4] = [0]
      self.graph_list[5] = [2, 0]
      self.graph_list[6] = [0]
      self.graph_list[7] = [7, 4, 3]
      self.graph_list[8] = [8, 9]
      self.graph_list[9] = [9]

      # self.graph_list[0] = [1, 2, 7]
      # self.graph_list[1] = [3]
      # self.graph_list[2] = [4]
      # self.graph_list[3] = [5]
      # self.graph_list[4] = [3, 6, 7]
      # self.graph_list[5] = [1]
      # self.graph_list[6] = []
      # self.graph_list[7] = []      
    ...
    def traverse_dfs(self, node):
        ...
        for neighbour in self.graph_list[node]:
            ...
            if not self.visited[neighbour]:
                ...
                if self.start_time[node] > self.start_time[neighbour] and self.end_time[neighbour] > 0:
